...
img1_src = cv2.imread("./images_/img_6_3.png", cv2.IMREAD_GRAYSCALE)
img2_src = cv2.imread("./images_/img_6_0.png", cv2.IMREAD_GRAYSCALE)
...
img1_color2 = cv2.cvtColor(img1, cv2.COLOR_BAYER_BG2BGR)
if linesP.any() != None:
    for line in linesP:
        x1, y1, x2, y2 = line[0]
...
ress.append(img1_color1),ress.append(img1_color2),ress.append(img2_color1)
